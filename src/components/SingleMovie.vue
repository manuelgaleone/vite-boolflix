...
<template>
    ...
    <div class="col-3 px-2 py-2 ">
        <div class="movie movie_card">
            ...
            <div v-if="movie.poster_path === null || movie.poster_path === undefined" :style="{backgroundImage:'url(https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/00d53663-c0cd-46e9-9aba-bed9180648cd/d5c3vm5-20410fd2-bb67-4a27-870e-adb06437a71c.png?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..BADD_GnMLXva7O9jwAHBzsKBhvpI_oAyjiccAPItofE)'}"  class="movie_elements movie_card text-left">
